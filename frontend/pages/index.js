  ...
  if (!isLoggedIn) {
    return (
      <main className="flex h-screen w-full items-center justify-center bg-gray-50 dark:bg-gray-900 font-sans text-gray-800 dark:text-gray-200">
        <div className="w-full max-w-md rounded-2xl border border-gray-200/50 dark:border-gray-800 bg-white/80 dark:bg-gray-800/80 p-8 shadow-2xl backdrop-blur-xl transition-all animate-in fade-in zoom-in-95">
